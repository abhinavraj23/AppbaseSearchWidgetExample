...
public class ClientSuggestionsAdapter extends RecyclerView.Adapter<ClientSuggestionsViewHolder> {
    ...
    /**
     * Initiates ClientSuggestionsAdapter with default topEntries parameter
     ...
     */
    public ClientSuggestionsAdapter(ArrayList<ClientSuggestionsModel> suggestions, String queryText, boolean shouldHighlight, boolean showHits, boolean searchResultImage, boolean redirectIcon) {
    ...
    /**
     * Initiates ClientSuggestionsAdapter
     *
     * @param suggestions List of suggestions to be added
     * @param queryText The text which is queried/written in the search bar
     * @param shouldHighlight Should highlight the queried text or not
     ...
     */
    public ClientSuggestionsAdapter(ArrayList<ClientSuggestionsModel> suggestions, String queryText, boolean shouldHighlight, boolean showHits, boolean searchResultImage, boolean redirectIcon, int topEntries) {
        this.suggestions = suggestions;
        this.queryText = queryText;
        this.shouldHighlight = shouldHighlight;
        this.showHits = showHits;
    ...
    /**
     * Inserts an item in ClientSuggestionsAdapter
    ...
    /**
     * Deletes an item from ClientSuggestionsAdapter
